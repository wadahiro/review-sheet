...
// `cd tests/fixtures/projects/<n> && bun run ../../src/cli.ts import --spec review-sheet/build.yml -o input.json`,
...
function buildActual(exampleName: string): ReturnType<typeof assembleFromSpecWithReport> {
  const exampleRoot = join(REPO_ROOT, "tests", "fixtures", "projects", exampleName);
