...
//     httpd-directives problem from the project. Always shown before it acts
...
export type InteractiveQuestion =
  ...
  | {
      ...
      pattern: string; // display form, e.g. "clients[clientId=oidc-app].*"
...
// identity predicate (`[field=value]`, e.g. `clients[clientId=oidc-app]` —
