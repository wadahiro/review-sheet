...
export type StructuralSplit = {
  ...
  //              (`oidc-app.publicClient`) and the component slot is left to
...
export type NestedSplit = {
  ...
  // asking what internal-ldap does means the connection AND what it makes of a
  // directory entry, so the outline reads `internal-ldap > Mappers > username`
